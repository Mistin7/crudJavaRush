package ru.mistin.crudJR.controller;
...
import ru.mistin.crudJR.service.UserService;
...
public class UserController {
    ...
    public String addUsers(@ModelAttribute("user") User user, @PathVariable("page") Integer currentPage)
    {
        ...
        {
            user.setCreateDate(this.userService.getUserById(user.getId()).getCreateDate());
